            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('products/*') || request()->is('products') ? ' active' : '' }}" href="/products">
                                <i class="nav-main-link-icon si si-cursor"></i>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('genders/*') || request()->is('genders') ? ' active' : '' }}" href="/genders">
                                <i class="nav-main-link-icon si si-cursor"></i>
                ...
                <div class="row fs-sm">
                    <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-end">
                        Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold"
                            href="https://github.com/romainsilvy" target="_blank">Romain</a> & <a class="fw-semibold"
                            href="https://github.com/Ayatooo" target="_blank">Louis</a>
                    </div>
                    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                        <span class="fw-semibold" target="_blank">Yselling</span> &copy; <span
